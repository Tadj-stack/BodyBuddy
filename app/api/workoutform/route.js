...
export const POST = async (request) => {
  try {
    ...
    console.log("Received formData: ", formData); // Log formData object (Note: This may not log detailed content due to formData's nature)
    ...
    // Log each piece of extracted data
    ...
    // If handling the image, you may also want to log that you received a file
    if (image) console.log("Received an image file");
    await connect();
    ...
    console.log("Saved Workout with Image: ", savedWorkout);
