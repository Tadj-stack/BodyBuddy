...
useEffect(() => {
  console.log(MessageCount); // Log MessageCount after state update
  ...
  return (
    <aside className={styles.sidebar}>
      <div className={styles.logo}>
        ...
        <a href="#" className={styles.a}>BodyBuddy</a>
      </div>
      ...
      {!isProfilePage && (
        <div className={styles.profile}>
          <Link href="/Profile">
          <img src={profile?.profileImage || "/images/profileImages/profile.jpg"} alt="Profile" className={styles.profileImage} />
          </Link>
