...
const handleDateChange = (date) => {
  ...
  const handleSubmitdata = async (e) => {
    ...
    const formData = {
      height,
      weight,
      age: selectedDate ? calculateAge(selectedDate) : null,
      gender,
      goal:selectedGoals,
        ...
        <div className={styles.container}> 
            ...
            <div className="brand">
                ...
                <div className={styles.text}>
                    <h1>Welcome! Let's customize BodyBuddy together based on your goals.</h1>
                </div>
                <div>
  ...
  {etape === 2 && (
                    <div className={styles.container}>
                        <form className={styles.form} onSubmit={handleSubmit}>
                            ...
                            <div className={styles.inputBox}> 
                                <span className={styles.details}>Weight (Lbs)</span>
                                <input
                                    type="text"
